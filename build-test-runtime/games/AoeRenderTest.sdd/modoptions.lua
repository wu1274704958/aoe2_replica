return {
	...
	aoe_anchor_calibration_unit = {
		name = "AOE calibration unit",
		desc = "AOE ranged unit rendered and fired in all 16 directions",
		type = "list",
		def = "aoe_chukonu",
		items = {
			{ key = "aoe_archer", name = "Archer" },
			{ key = "aoe_chukonu", name = "Chu Ko Nu" },
	...
	aoe_anchor_calibration_target_unit = {
		name = "AOE calibration target",
		desc = "Hostile stationary target placed in front of every calibration unit",
		type = "list",
		def = "aoe_spearman",
		items = {
			{ key = "aoe_spearman", name = "Spearman" },
			{ key = "aoe_west_castle_age3", name = "Castle" },
		},
	},
	aoe_anchor_calibration_target_distance = {
		name = "AOE calibration target distance",
		desc = "Centre distance between every ranged unit and its forward target",
		type = "number",
		def = 180,
		min = 32,
		max = 1024,
	...
	aoe_anchor_calibration_move_state = {
		name = "AOE calibration move state",
		desc = "Native Move State: 0 Hold Position, 1 Maneuver, 2 Roam",
		type = "number",
		def = 0,
		min = 0,
		max = 2,
